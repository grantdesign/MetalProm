	...
	<div class="container">
		<div class="breadcrumbs-main">
			<ol class="breadcrumb">
				...
				<li><a href="{{ route('categories.index', $category->parent->slug) }}">{{ $category->parent->name }}</a></li>
...
<div class="register">
	<div class="container">
		...
		<a href="{{ route('posts.create', $category->id) }}" class="btn btn-primary">Добавить объявление</a>
		@if(!$posts->isEmpty())
