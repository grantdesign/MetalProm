	...
	<div class="container">
		<div class="breadcrumbs-main">
			<ol class="breadcrumb">
				...
				<li><a href="{{ route('companies.index') }}">Каталог поставщиков</a></li>
...
<div class="single contact">
	<div class="container">
				...
				<div class="sngl-top">
					<div class="col-lg-5 single-top-left">
						<div class="flexslider">
							<div class="img-fluid">
								<img src="{{ asset('storage/'.$user->image) }}" data-imagezoom="true" class="img-responsive" alt=""/>
							</div>
						</div>
						<!-- FlexSlider -->
		...
		<div class="tabs">
			<ul class="menu_drop">
				<li class="item1"><a href="#"><img src="{{ asset('assets/images/arrow.png') }}" alt="">Регион</a>
					<ul>
						<li><a>{{ $user->region->district->name }} / {{ $user->region->name }}</a></li>
					</ul>
				</li>

				<li class="item2"><a href="#"><img src="{{ asset('assets/images/arrow.png') }}" alt="">Контакты</a>
					<ul>
						<li><a>{{ $user->person }} <br> Email: {{ $user->email }}</a></li>
					</ul>
				</li>
				...
				<li class="item4"><a href="#"><img src="{{ asset('assets/images/arrow.png') }}" alt="">Сайт</a>
					<ul>
						<li><a href="{{ $user->site }}" target="_blank">{{ $user->site }}</a></li>
					</ul>
				</li>
			</ul>
		</div>
